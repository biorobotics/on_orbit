...
def plot_tracking_error_and_manipulability(trial_dirs, urdf_file):
    '''Process multiple directories, each containing peg/nozzle position error and joint angles, and plot tracking error and manipulability.'''
    ...
    plt.title('Tracking Error and Manipulability Across Multiple Trials')
    plt.tight_layout()
    plt.show()

def main():
    # Specify any number of directories, each containing 'peg/nozzle position errors' and 'mrv_arm_joint_angles_trj.npy'
    trial_dirs = [
    ...
    plot_tracking_error_and_manipulability(trial_dirs, urdf_file)
